...
Uso típico na VPS (parar o Oráculo e ocupar a mesma porta):
  ...
  python3 server_for_serveless/serve_maintenance.py --host 0.0.0.0 --port 8765

A porta omissão 8765 iguala a do `server_for_serveless/main.py`. Só usa a biblioteca padrão.

  # Windows (raiz do repo):
  python server_for_serveless/serve_maintenance.py --port 8765
"""
