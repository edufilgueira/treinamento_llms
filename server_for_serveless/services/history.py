...
from server_for_serveless.db.auth_db import get_user_names
...
def session_context_block_text(user_id: int) -> str:
    ...
    return (
        f"baseado no nome atualizado para [{nome}], continuaremos.\n"
...
def finalize_messages_for_upstream(
    ...
    *,
    ...
    from server_for_serveless.services.llama_context import (
