...
(function () {
  ...
  const settingsInferenceSingleFlight = document.getElementById("settings-inference-single-flight");
  ...
  async function openSettingsModal() {
    ...
    try {
      ...
      if (r.ok) {
        ...
        if (currentUserIsAdmin) {
          if (settingsInferenceSingleFlight) {
            settingsInferenceSingleFlight.checked = !!j.inference_single_flight;
          }
          if (settingsUiBlockCrossUser) {
            settingsUiBlockCrossUser.checked = !!j.ui_block_cross_user_generation;
          }
          if (settingsUiOnly) {
            settingsUiOnly.checked = !!j.ui_only;
          }
        }
  ...
  document.getElementById("settings-save")?.addEventListener("click", async function () {
    ...
    if (currentUserIsAdmin) {
      ...
      body.ui_block_cross_user_generation = !!(
        settingsUiBlockCrossUser && settingsUiBlockCrossUser.checked
      );
      body.ui_only = !!(settingsUiOnly && settingsUiOnly.checked);
    }
    try {
